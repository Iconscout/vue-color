<template>
  <div
    :class="[
      'vc-iconscout-c',
      disableAlpha ? 'vc-iconscout-c__disable-alpha' : '',
    ]"
  >
    <div class="vc-iconscout-c-saturation-wrap">
      <saturation v-model="colors" @change="childChange"></saturation>
    </div>
    <div v-if="defaultPalette.length" class="vc-iconscout-c-defaults">
      <button
    ...
    <div class="vc-iconscout-c-body">
      ...
      <div class="vc-iconscout-c-fields-wrap" v-if="!disableFields">
        ...
        <div
          v-if="!disableToggle"
          class="vc-iconscout-c-toggle-btn"
          @click="toggleViews"
        >
          ...
          <div
            class="vc-iconscout-c-toggle-icon-highlight"
            v-show="highlight"
          ></div>
        </div>
        <!-- btn -->
        ...
        <div class="vc-iconscout-c-color-wrap">
          <div
            class="vc-iconscout-c-active-color"
...
export default {
  ...
  methods: {
    onCopy() {
      const self = this;
      import("copy-to-clipboard").then((r) => {
    ...
    focusHexInput() {
      this.$refs.hexInput && this.$refs.hexInput.focusAndSelect();
    },
  },
};
</script>
...
.vc-iconscout-c-hue-wrap .vc-hue-picker,
.vc-iconscout-c-alpha-wrap .vc-alpha-picker {
  width: 14px;
  height: 14px;
...
.vc-iconscout-c-color-transparent {
  ...
  background-image: -webkit-linear-gradient(
    ...
    -webkit-linear-gradient(45deg, #e4e9f2 25%, transparent 25%, transparent 75%, #e4e9f2
          75%, #e4e9f2) !important;
